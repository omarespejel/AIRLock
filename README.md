...
| Pinned Stwo adapter (`airlock-stwo`) | real demo proof, verifier-derived OODS requests, sample-only mutations, raw-PCS/framework replay, subprocess containment, verified evidence bundles |
...
- Replay-bundle checksums establish deterministic internal consistency. They do
  not authenticate who produced a bundle; external publication must pin or sign
  the bundle digest separately.
