...
The bundle remains inside the verifier-boundary lane. Other proof containers
remain outside this adapter's coverage. The runner is not an OS sandbox, and
bundle checksums do not authenticate a producer. Statement binding,
protocol/FRI/Fiat-Shamir analysis, evidence/provenance, solver search, and
malicious-witness injection remain separate or
